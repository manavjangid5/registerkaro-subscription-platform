import {
  ...
  router.post('/register', validateBody(registerRequestSchema), async (req, res) => {
    const { email, password, name } = (req as ValidatedRequest<RegisterRequest>)
      .validatedBody!;
  ...
  router.post('/login', validateBody(loginRequestSchema), async (req, res) => {
    const { email, password } = (req as ValidatedRequest<LoginRequest>).validatedBody!;
  ...
  router.post('/refresh', validateBody(refreshTokenRequestSchema), async (req, res) => {
    const { refreshToken } = (req as ValidatedRequest<RefreshTokenRequest>)
      .validatedBody!;
